...
const HomeBottom = () => {
  return (
    <SimpleGrid
      ...
      bgColor="white" 
    >
      <Text fontWeight="bold" color="#1A1A1A" fontSize="18.5px" >
        Stay Healthy with Tata 1mg: Your Favourite Online Pharmacy and
        Healthcare Platform
      </Text>
      <Text fontWeight="bold" color="#1A1A1A" >We Bring Care to Health.</Text>
      <Text>
      ...
      <Text fontWeight="bold" color="#1A1A1A" >Tata 1mg: Your Favourite Online Pharmacy!</Text>
      <Text>
      ...
      <Text fontWeight="bold" color="#1A1A1A" >The Feathers in Our Cap</Text>
      <Text>
      ...
      <Text fontWeight="bold" color="#1A1A1A" >The Services We Offer</Text>
      <Text>

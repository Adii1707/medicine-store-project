...
import {sliderImage} from "../Data2/Data";
    ...
    return (
      <Box bgColor="white" >
        <Flex pt="7px" gap="0px" borderBottom="2px solid #E0E0E0" m="auto" justifyContent={["center","center","center",""]} flexDirection={["column-reverse","column-reverse", "column-reverse", "row"]} >
          ...
          <Box>
           <Link to={"/products1"} > <Image cursor="pointer" h="203px" src="https://onemg.gumlet.io/a_ignore,w_480,h_200,c_fit,q_auto,f_auto/16bfcc2c-7f57-4571-a29e-d69b0af564c8.png" />
          </Link></Box>
        </Flex>

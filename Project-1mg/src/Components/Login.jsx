    ...
    <>
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Text fontSize="30px" fontWeight="bold" mb="20px">Login</Text>
            <Text fontSize="14px" >Get access to your orders, lab tests & doctor consultations</Text>
            <br />
            ...
            <Box>
              ...
              <Flex ml="50px" mt="60px" >
                ...
                <Link color="#FF6F61" ml="5px" fontWeight="bold" >Sign Up</Link>
              </Flex>
